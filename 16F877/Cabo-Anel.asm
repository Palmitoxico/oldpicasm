...
;decfsz	Cont2 , 1				;A interrupção acontece a cada 10 milisegundos



movlw	.70						;Contador do BIP para o começo
subwf	N2_C,0
btfsc	STATUS,Z	
bcf		BIP
...
movlw	'T'					;Escreve "Tempo restante:"
call	enviar_char_lcd		;
movlw	'e'					;
call	enviar_char_lcd		;
movlw	'm'					;
...
Main							;Rotina principal
	...
	movlw	'A'					;Escreve "Apoie o anel no"/"gancho do inicio"
	call	enviar_char_lcd		;
	movlw	'p'					;
	call	enviar_char_lcd		;
	movlw	'o'					;
